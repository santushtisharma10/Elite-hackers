// @ts-nocheck
/**
 * Base on https://github.com/umijs/H:/Elite-hackers/dashboard/node_modules/umi-request
 */
import {
  extend,
  Context,
  ...
  RequestInterceptor,
  ResponseInterceptor,
} from 'H:/Elite-hackers/dashboard/node_modules/umi-request';
// @ts-ignore
...
import useUmiRequest, { UseRequestProvider } from 'H:/Elite-hackers/dashboard/node_modules/@ahooksjs/use-request';
import {
  BaseOptions,
  ...
  PaginatedParams,
  PaginatedResult,
} from 'H:/Elite-hackers/dashboard/node_modules/@ahooksjs/use-request/lib/types';
